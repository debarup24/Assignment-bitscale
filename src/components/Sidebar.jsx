...
const Sidebar = () => {
  return (
    <div className="hidden md:hidden lg:visible px-6 pt-6 pb-4 h-[calc(100vh-65px)] gap-10 lg:flex lg:flex-col justify-between items-center border-r border-r-[#E5E5E5] max-w-14 max-lg:hidden">
